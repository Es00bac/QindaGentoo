...
# r1 moves the pin to the TabStrip fix: the strip counted its model with
# Array.isArray, which a C++ QStringList sequence is not, so every tab
# vanished (QindaCalc's sheet strip rendered empty). A revision bump, not a
# silent EGIT_COMMIT edit - otherwise nothing tells Portage to rebuild.
EGIT_COMMIT="7fdc60ccf7e09158f660fbba74d4b00ed3b11e8e"
